...
var UNKNOWN = 'UNKNOWN';
var read = require('read-installed-packages');
...
/**
 * Search for dependencies and list their licenses
 * 
 * @param {string} options.start The path to where the package.json file lives
 * @param {boolean} options.unknown If true, only show unknown licenses
 * @param {number | 'all'} options.depth The levels of transitive dependencies to include, or 'all' for infinity
 * @param {'dependencies' | 'devDependencies' | 'bundledDependencies' | 'bundleDependencies' | 'optionalDependencies' | 'peerDependencies' | 'all'} options.include Which types of dependencies to include
 * @param {string} options.meta The path to a metadata JSON file containing override license information for modules
 * @param {object -> void} callback to where it will return the list of licenses
 */
